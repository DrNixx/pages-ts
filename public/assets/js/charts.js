    ...
    $(document).ready(function() {
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    data: seriesData[0],
                    color: pg.getColor('success-light', .5), // Get Pages contextual color
                    name: 'DB Server'
                }, {
                    data: seriesData[1],
                    color: pg.getColor('master-light'), // Get Pages contextual color
                    name: 'Web Server'
                }]
            });
        ...
        (function() {
            ...
            var graph = new Rickshaw.Graph({
                ...
                series: [{
                    data: seriesData[0],
                    color: pg.getColor('complete-light'), // Get Pages contextual color
                    name: "New users"
                }, {
                    data: seriesData[1],
                    color: pg.getColor('master-light'), // Get Pages contextual color
            ...
            (function() {
                ...
                nv.addGraph(function() {
                    var chart = nv.models.stackedAreaChart()
                        // Gets color (rgba) value using Pages util function pg.getColor()
                        .color([
        ...
        var drawSparklinePie = function() {
            $("#sparkline-pie").sparkline([4, 3, 2, 1], {
                ...
                height: '200',
                sliceColors: [pg.getColor('warning'), pg.getColor('danger'), pg.getColor('master-light'), pg.getColor('master')]
        ...
        var drawSparklineLine = function() {
            $("#sparkline-line").sparkline([0, 10, 8, 20, 15, 10, 15, 5], {
                ...
                height: '200',
                chartRangeMax: 40,
                fillColor: pg.getColor('danger', .3), // Get Pages contextual color
            ...
            $("#sparkline-line").sparkline([10, 10, 25, 29, 20, 22, 20, 22], {
                ...
                fillColor: pg.getColor('warning', .3), // Get Pages contextual color
                lineColor: 'rgba(0,0,0,0)',
                highlightLineColor: 'rgba(0,0,0,.09)',
                highlightSpotColor: 'rgba(0,0,0,.21)',
